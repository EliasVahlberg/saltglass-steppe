...
use crate::GameState;
use crate::game::{get_item_def, trading::TradeInterface};
            ...
            trade_interface
                ...
                .map(|(i, item)| {
                    let def = match get_item_def(&item.item_id) {
                        ...
                        None => {
                            ...
                            return ListItem::new(Line::from(vec![
                                ...
                                Span::styled(
                                    format!("MISSING: {} | {} scrip", item.item_id, item.price),
                    ...
                    ListItem::new(Line::from(vec![
                        ...
                        Span::styled(
                            format!("{} | {} | Stock: {}", name, price, stock_str),
                            style,
                        ),
                    ]))
                })
        ...
        TradeMode::Sell => {
            state
                ...
                .map(|(i, item_id)| {
                    ...
                    let sell_price =
                        (def.value as f32 * trade_interface.sell_price_multiplier) as u32;
                    let name = format!("{: <20}", def.name);
