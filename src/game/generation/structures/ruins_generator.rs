use super::{Rectangle, Room, Structure, StructureGenerator, StructureParams, StructureType, POIType, SpawnPoint};
...
impl RuinsGenerator {
    ...
    fn create_vitrified_library_layout(&self, size: (u32, u32), _rng: &mut ChaCha8Rng) -> Structure {
    ...
    fn generate(&self, params: &StructureParams, rng: &mut ChaCha8Rng) -> Option<Structure> {
        match params.structure_type {
            StructureType::Ruins => {
                ...
                if params.theme == "vitrified_library" || params.quest_requirements.contains(&"the_broken_key".to_string()) {
