...
use super::super::algorithm::{
    ...
    GenerationMetadata, GenerationResult, LayerType, ParameterConstraints, ParameterDefinition,
    ParameterType, ParameterValue, ValidationError,
};
    ...
    fn generate(&self, context: &AlgorithmContext) -> Result<GenerationResult, GenerationError> {
        ...
        for x in 0..context.width {
            for y in 0..context.height {
                ...
                for _ in 0..octaves {
                    value += (noise
                        .get_noise((x as f64 * frequency) as f32, (y as f64 * frequency) as f32)
                        as f64)
                        * amplitude;
        ...
        let metadata = GenerationMetadata {
            ...
            algorithm_metadata: {
                ...
                meta.insert(
                    "octaves".to_string(),
                    serde_json::Value::Number(serde_json::Number::from(octaves)),
                );
                meta.insert(
                    "persistence".to_string(),
