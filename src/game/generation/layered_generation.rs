    ...
    fn generate_layer(&self, layer: &LayerConfig, rng: &mut ChaCha8Rng) -> Map {
        ...
        match layer.algorithm.as_str() {
                        ...
                        for x in 1..(MAP_WIDTH - 1) {
                            ...
                            for dy in -1..=1 {
                                for dx in -1..=1 {
                                    ...
                                    if nidx < map.tiles.len()
                                        && matches!(map.tiles[nidx], Tile::Floor { .. })
                                    {
                                        floor_count += 1;
                                    }
                                }
            ...
            "connect" => {
                ...
                let corridor_width = layer
                    .algorithm_params
                    .get("corridor_width")
                    .and_then(|v| v.as_u64())
                    .unwrap_or(1) as usize;
                let max_corridors = layer
                    .algorithm_params
                    .get("max_corridors")
                    .and_then(|v| v.as_u64())
                    .unwrap_or(5) as usize;
