...
mod generation_tests {
    ...
    fn test_template_basic_instantiation() {
        ...
        let template = ContentTemplate {
            ...
            parameters: {
                ...
                params.insert(
                    ...
                    Value::String("A test room".to_string()),
                );
                params
            },
            variants: vec![],
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(12345);
        let result = library
            .instantiate("test_room", &context, &mut rng)
            .unwrap();
    ...
    fn test_template_inheritance() {
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(12345);
        let result = library
            .instantiate("glass_room", &context, &mut rng)
            .unwrap();
    ...
    fn test_template_variable_substitution() {
        ...
        let template = ContentTemplate {
            ...
            parameters: {
                ...
                params.insert(
                    "description".to_string(),
                    Value::String("A ${material} room with ${count} items".to_string()),
                );
                params
            },
            variants: vec![],
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(12345);
        let result = library
            .instantiate("variable_room", &context, &mut rng)
            .unwrap();

        assert_eq!(
            result.get("description").unwrap().as_str().unwrap(),
            "A crystal room with 3 items"
        );
    }
    ...
    fn test_template_variant_selection() {
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(12345);
        let result = library
            .instantiate("variant_room", &context, &mut rng)
            .unwrap();
    ...
    fn test_grammar_weighted_selection() {
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(12345);
        let result = grammar
            .generate("weighted_rule", &context, &mut rng)
            .unwrap();
    ...
    fn test_biome_system_deterministic() {
        use crate::game::generation::biomes::{BiomeGenerationContext, BiomeSystem};
    ...
    fn test_constraint_system_deterministic() {
        use crate::game::generation::constraints::{ConstraintContext, ConstraintSystem};
    ...
    fn test_constraint_validation_types() {
        use crate::game::generation::constraints::{
            ConstraintContext, ConstraintRule, ConstraintSeverity, ConstraintSystem, ConstraintType,
        };
        use crate::game::map::Map;
        use crate::game::world_map::Biome;
    ...
    fn test_critical_constraints_satisfaction() {
        use crate::game::generation::constraints::{
            ConstraintResult, ConstraintSeverity, ConstraintSystem,
        };
