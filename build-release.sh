...
cp target/x86_64-unknown-linux-gnu/release/tui-rpg "$RELEASE_DIR/linux/"
...
cp target/x86_64-pc-windows-gnu/release/tui-rpg.exe "$RELEASE_DIR/windows/"
...
cp target/x86_64-apple-darwin/release/tui-rpg "$RELEASE_DIR/macos/"
...
cd "$RELEASE_DIR"
zip -r "tui-rpg-$VERSION-linux-x86_64.zip" linux/
zip -r "tui-rpg-$VERSION-windows-x86_64.zip" windows/
zip -r "tui-rpg-$VERSION-macos-x86_64.zip" macos/
