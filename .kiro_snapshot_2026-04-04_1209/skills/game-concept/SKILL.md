---
name: game-concept
description: The foundational game concept, world premise, and high-level design vision for Saltglass Steppe. Use when making decisions about scope, feature direction, or ensuring new work aligns with the core vision.
---
