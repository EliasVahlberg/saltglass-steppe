---
name: des-usage
description: How to write and run DES (Debug Execution System) test scenarios. Use when creating new test scenarios, debugging failing tests, or understanding the DES command and assertion syntax.
---
