...
- [game_systems_overview.md](../architecture/game_systems_overview.md) — Generation pipeline integration
- [PROCEDURAL_GENERATION_COMPREHENSIVE_GUIDE.md](PROCEDURAL_GENERATION_COMPREHENSIVE_GUIDE.md) — Procedural systems
- [CONSTRAINT_SYSTEM_GUIDE.md](CONSTRAINT_SYSTEM_GUIDE.md) — Constraint validation

---

*Algorithm designed for Saltglass Steppe map generation. Named for the thematic concept of bridging isolated regions through minimal "seams" in the glass-fused landscape.*
