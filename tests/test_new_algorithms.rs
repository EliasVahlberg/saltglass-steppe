...
fn test_all_new_algorithms() {
    ...
    println!(
        "✅ Drunkard's Walk generated {} tunnel tiles",
        tunnels.len()
    );
    assert!(
        !tunnels.is_empty(),
        "Drunkard's Walk should generate some tunnels"
    );
    ...
    println!(
        "✅ Simple Rooms generated {} rooms and {} corridor tiles",
        rooms.len(),
        corridors.len()
    );
    ...
    assert!(
        !walls.is_empty(),
        "Cellular Automata should generate some walls"
    );
    ...
    println!(
        "✅ BSP generated {} rooms and {} corridors",
        bsp_rooms.len(),
        bsp_corridors.len()
    );
